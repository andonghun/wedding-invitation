...
const SlotMachine = () => {
  ...
  const spin = () => {
    ...
    // 슬롯 머신 횟수 3회 이상인 경우, 50퍼 확률로 당첨
    const isWin = spinCount >= 2 && Math.random() < 0.5;
  ...
  return (
    <div className="flex w-full flex-col justify-center items-center gap-5">
      ...
      <button
        className={`animate-pulse flex justify-center items-center w-[150px] h-[150px] rounded-full ${styles.Container} hover:bg-second active:bg-white active:translate-y-1`}
        onClick={spin}
      >
